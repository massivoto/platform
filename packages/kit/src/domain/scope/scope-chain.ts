 ...
 */
export function createEmptyScopeChain(): ScopeChain {
  return { current: {} }
}
 ...
 */
export function pushScope(chain: ScopeChain): ScopeChain {
 ...
 */
export function popScope(chain: ScopeChain): ScopeChain {
  if (!chain.parent) {
 ...
 */
export function lookup(name: string, chain: ScopeChain): any {
 ...
 */
export function write(name: string, value: any, chain: ScopeChain): void {
 ...
 */
export function cloneScopeChain(chain: ScopeChain): ScopeChain {
  const cloned: ScopeChain = {
