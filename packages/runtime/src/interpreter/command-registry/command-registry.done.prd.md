...
**Last updated:** 2026-01-20
**Test:** `npx vitest run packages/runtime/src/interpreter/command-registry`
**Progress:** 5/5 (100%)
...
**Last updated:** 2026-01-20
**Test:** `npx vitest run packages/runtime/src/interpreter/command-registry/core-handlers-bundle.spec.ts`
**Progress:** 4/4 (100%)
...
**Last updated:** 2026-01-20
**Test:** `npx vitest run packages/runtime/src/interpreter/command-registry/errors.spec.ts`
**Progress:** 2/3 (67%)
...
```
packages/runtime/src/interpreter/
├── handlers/
