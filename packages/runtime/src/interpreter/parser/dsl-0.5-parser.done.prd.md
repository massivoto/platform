...
The parser transforms DSL source text into an Abstract Syntax Tree (AST) that can be evaluated, and executed by downstream interpreter stages. It uses the `@masala/parser` library for parser combinators.
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/command`
**Progress:** 5/5 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/arg-parser.spec.ts`
**Progress:** 4/4 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details/tokens/literals-parser.spec.ts`
**Progress:** 3/4 (75%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details`
**Progress:** 2/2 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details/unary-parser/member-parser.spec.ts`
**Progress:** 3/3 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details/unary-parser/unary-parser.spec.ts`
**Progress:** 2/2 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details/binary-operation`
**Progress:** 4/4 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details/binary-operation/logical-parser.spec.ts`
**Progress:** 3/3 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/args-details/pipe-parser`
**Progress:** 6/6 (100%)
...
**Last updated:** 2026-01-16
**Test:** `npx vitest run packages/runtime/src/interpreter/parser/instruction-parser.spec.ts`
**Progress:** 3/3 (100%)
