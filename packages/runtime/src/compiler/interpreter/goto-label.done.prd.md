...
**Last updated:** 2026-01-23
**Test:** `npx vitest run packages/runtime/src/compiler/interpreter/flow-commands.spec.ts`
**Progress:** 9/9 (100%)
...
**Last updated:** 2026-01-23
**Test:** `npx vitest run packages/runtime/src/compiler/ast-processing/label-validation.spec.ts`
**Progress:** 3/3 (100%)
